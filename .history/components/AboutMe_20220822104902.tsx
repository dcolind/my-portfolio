  ...
  return (
    <section className="bg-white dark:bg-gray-800">
      <div className="max-w-6xl mx-auto h-48 bg-white dark:bg-gray-800">
        <h1 className=" text-5xl text-green-400 md:text-9xl font-bold py-20 text-center md:text-left">
          About Me
        </h1>
      </div>
      <div className="bg-[#F1F1F1] -mt-4 dark:bg-gray-900">
        <div className="text-container max-w-6xl mx-auto pt-20 text-white">
          <p
        ...
        <div className="pt-20 grid grid-cols-1 md:grid-cols-3 max-w-6xl mx-auto gap-y-20 gap-x-20">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex flex-row flex-wrap mt-8">
              ...
              />
              <img
                src="https://th.bing.com/th/id/R.845c48b2d04d8044d1075e1568445db8?rik=vYWtFKT1ixeh7Q&pid=ImgRaw&r=0"
                className="h-20 w-20 mx-4 my-4"
              />
              <img
