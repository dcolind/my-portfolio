  ...
  return (
    ...
    <div className="space-x-4 flex flex-row items-center">
          ...
          <a
            ...
            className="text-base font-normal text-green-500 hover:text-gray-400"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
          ...
          <a
            ...
            className="text-base font-normal text-blue-700 hover:text-gray-400"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
...
const NavigationItem = (props) => (
  <Link href={props.href}>
    <a className="p-5 hover:text-gray-400">{props.children}</a>
  </Link>
)
