  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto h-48 bg-gray-800  ">
        <h1 className=" text-5xl text-yellow-400 md:text-9xl font-bold py-20 text-center md:text-left">
          Contact
        </h1>
      </div>
      <div className=" rounded-md shadow-md bg-gray-900 p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
